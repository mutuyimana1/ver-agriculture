...
console.log("result",result)
  ...
  console.log("newsDatanewsDatanewsData",newsData)
  return (
    <>
      <Header />
      <main>
        ...
        {viewNewsDetails && (
          <h1
            className="flex text-lg gap-2 ml-3 mt-3"
            onClick={() => setViewNewsDetails(false)}
          >
            <IoArrowBackCircleSharp size={32} color="green" />
        ...
        >
          <div className="container">
            ...
            {isFetching ? (
              ...
              <div>
                {viewNewsDetails ? (
                  <NewsDetails data={newDetailedData} />
                ) : (
